...
function ur() {
  if (Re)
    return k;
  Re = 1;
  var g = Oe, P = Symbol.for("react.element"), V = Symbol.for("react.fragment"), R = Object.prototype.hasOwnProperty, F = g.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, A = { key: !0, ref: !0, __self: !0, __source: !0 };
  function S(_, l, T) {
    var d, h = {}, m = null, I = null;
    ...
    if (_ && _.defaultProps)
      for (d in l = _.defaultProps, l)
        h[d] === void 0 && (h[d] = l[d]);
    return { $$typeof: P, type: _, key: m, ref: I, props: h, _owner: F.current };
  }
...
function sr() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    var g = Oe, P = Symbol.for("react.element"), V = Symbol.for("react.portal"), R = Symbol.for("react.fragment"), F = Symbol.for("react.strict_mode"), A = Symbol.for("react.profiler"), S = Symbol.for("react.provider"), _ = Symbol.for("react.context"), l = Symbol.for("react.forward_ref"), T = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), m = Symbol.for("react.lazy"), I = Symbol.for("react.offscreen"), X = Symbol.iterator, Ce = "@@iterator";
    function we(e) {
    ...
    function Fe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === R || e === A || De || e === F || e === T || e === d || ke || e === I || Se || xe || je || typeof e == "object" && e !== null && (e.$$typeof === m || e.$$typeof === h || e.$$typeof === S || e.$$typeof === _ || e.$$typeof === l || // This needs to include all possible module reference object
...
(function(g) {
  process.env.NODE_ENV === "production" ? g.exports = ur() : g.exports = sr();
})(or);
const fr = K.jsxs, cr = ({ text: g }) => /* @__PURE__ */ fr("div", { className: "text", children: [
  "This is test text: ",
  g
] });
export {
